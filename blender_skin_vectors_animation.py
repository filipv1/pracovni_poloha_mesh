#!/usr/bin/env python3
"""
Blender animation script for SKIN-BASED vectors
Works with blender_export_skin_5614 or blender_export_skin_4298 directories
Handles trunk_skin_XXXX.obj files correctly
"""
...
print("\n" + "=" * 60)
print("SKIN-BASED VECTORS ANIMATION")
print("=" * 60)
...
# Set base directory - CHANGE THIS to match your export
...
if not base_dir.exists():
    ...
    for frame_idx in range(num_frames):
        ...
        # List of files to import for this frame - UPDATED FOR SKIN FILES
        files_to_import = [
            (f"frame_{frame_idx:04d}.obj", "Mesh", (0.8, 0.8, 0.8, 1.0)),
            (f"trunk_skin_{frame_idx:04d}.obj", "Trunk", (1.0, 0.2, 0.2, 1.0)),  # FIXED: trunk_skin_
            ...
            if filepath.exists():
                ...
                if bpy.context.selected_objects:
                    ...
                    if obj_type != "Mesh":
                        ...
                        # Mesh settings - OPAQUE (not transparent)
                        obj.show_in_front = False
                        obj.display_type = 'SOLID'
                        
                        # Create opaque material for mesh
                        ...
                        if bsdf:
                            ...
                            if "Alpha" in bsdf.inputs:
                                bsdf.inputs["Alpha"].default_value = 1.0  # 100% opacity
    ...
    print("\n" + "=" * 60)
    print("SKIN-BASED ANIMATION READY!")
    print(f"Total frames: {num_frames}")
    print(f"Total objects: {sum(len(objs) for objs in frames_data.values())}")
    print("\nVECTOR COLORS:")
    print("- RED: Trunk vector (SKIN vertices: 5614→2151)")
    print("- BLUE: Neck vector (SKIN vertices: 2151→9002)")
    print("- GREEN: Left arm")
    print("- YELLOW: Right arm")
    print("\nALL TRUNK AND NECK VECTORS ARE FROM SKIN SURFACE!")
    print("\nCONTROLS:")
